      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between z-10 relative">
        <div className="lg:w-1/2 text-left mb-10 lg:mb-0 lg:pr-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            <span className="gradient-text-blue">Kontaktieren Sie Uns</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-300 max-w-2xl">
            Haben Sie Fragen oder benötigen Sie Unterstützung? Unser engagiertes Team ist jederzeit bereit, Ihnen zu helfen. Kontaktieren Sie uns noch heute!
          </p>
        </div>
